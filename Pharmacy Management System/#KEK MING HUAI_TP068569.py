...
def bufferClearing(file): #Apply changes from buffer file
    proper=open(file,"r")
...
def saveChanges(): #Saves all changes to file
    bufferClearing("admins.txt")
    bufferClearing("customers.txt")
    bufferClearing("medicines.txt")
    bufferClearing("orders.txt")

    clear=open("buffer.txt","w").close() #Clear and close buffer file

def CMenu(username,password): #Registered customer menu
    saveChanges() #Save all previous changes

    oldcustdo=input("What would you like to do?\n[V] View catalog\n[S] Search medicine\n[A] Account details\n[C] My cart\n[X] Exit\n")
    match oldcustdo.strip().casefold():
        case "v":
        ...
        case "s":
            ...
            for line in medicines:
                if line.strip()==() or line.strip()==(""):
                    ...
                    details=line.split(";")
                if search.strip() in details[0].casefold() or search.strip() in details[0].capitalize():
                    ...
                    if next.casefold().strip()=="y":
                        continue
                    elif next.casefold().strip()=="n":
                        do2=input("What would you like to do?\n[O] Order\n[X] Exit\n")
                        if do2.casefold().strip()=="o":
        ...
        case "a": 
            ...
            if changeopt.casefold().strip()=="u":  #Proceed to change username
                can1=False
                can2=False
                change=False
                ...
                customers_1.close()
                CMenu(username,password)
            elif changeopt.casefold().strip()=="p": #Proceed to change password
                can1=False
                can2=False
                change=False
                ...
                customers_1.close()
                CMenu(username,password)
            elif changeopt.casefold().strip()=="m": #Proceed to change email address
                can1=False
                can2=False
                change=False
                ...
                customers_1.close()
                CMenu(username,password)
            elif changeopt.casefold().strip()=="a": #Proceed to change address
                can2=False
                change=False
                customers=open("customers.txt","r")
                customers.seek(0,0)
                while can2==False: #Make sure new address is different from old address
                    ...
                    for line in customers:
                        ...
                        if username==content[0] and newaddress==content[3]:
                            ...
                            break
                        elif newaddress.casefold().strip()=="x":
                            CMenu(username,password)
                        else:
                            continue
                    can2=True
                ...
                customers_1.close()
                CMenu(username,password)
            elif changeopt.casefold().strip()=="c": #Proceed to change contact number
                can2=False
                change=False
                customers=open("customers.txt","r")
                customers.seek(0,0)
                while can2==False: #Make sure one number only appear once
                    ...
                    for line in customers:
                        ...
                        if new_number==content[5]:
                            ...
                            break
                        elif new_number.casefold().strip()=="x":
                            CMenu(username,password)
                        else:
                            continue
                    can2=True
                ...
                customers_1.close()
                CMenu(username,password)
            elif changeopt.casefold().strip()=="g": #Proceed to change gender information
                can2=False
                change=False
                customers=open("customers.txt","r")
                customers.seek(0,0)
                ...
                customers_1.close()
                CMenu(username,password)
            elif changeopt.casefold().strip()=="d": #Proceed to change date of birth
                can2=False
                change=False
                customers=open("customers.txt","r")
                customers.seek(0,0)
                while can2==False: #Make sure new date is different from old date
                    ...
                    for line in customers:
                        ...
                        if new_date==content[7]:
                            ...
                            break
                        elif new_date.casefold().strip()=="x":
                            CMenu(username,password)
                        else:
                            continue
                    can2=True
                ...
                customers_1.close()
                CMenu(username,password)
            elif changeopt.casefold().strip()=="x":
                print("\nReturning to menu...\n")
                CMenu(username,password)
            else:
...
def New(): #Menu for new customers
    ...
    match newcustdo.strip().casefold():
        case "r":
            try:
...
def Login(user): #Universal login page for all user types
    ...
    for line in list:
        ...
        if username.strip()==content[0] and password.strip()==content[1]:
            login=True
            break
        elif username.strip().casefold()=="x" or password.strip().casefold()=="x":
            Main()
        else:
            continue
    list.close()
    ...
    match look.strip().casefold():
        case "a":
            ...
            while success==False:    
                ...
                if add1.casefold().strip()=="x" or add2.casefold().strip()=="x" or add3.casefold().strip()=="x" or add4.casefold().strip()=="x" or add5.casefold().strip()=="x" or add6.casefold().strip()=="x" or add7.casefold().strip()=="x":
                    print("You cannot use this information.")
                    AMed()
                    break
                elif add1.casefold().strip()=="" or add2.casefold().strip()=="" or add3.casefold().strip()=="" or add4.casefold().strip()=="" or add5.casefold().strip()=="" or add6.casefold().strip()=="" or add7.casefold().strip()=="":
                    print("You cannot use this information.")
                    AMed()
                    break
            ...
            if search.casefold().strip()=="xxx":
                ...
                for line in medicines:
                    if line.strip()==() or line.strip()==(""):
                        ...
                        details=line.split(";")
                    if search in details[0].casefold() or search in details[0].capitalize() or search in details[7].casefold():
                        print("\nName: "+details[0]+"\nCategory: "+details[7]+"\nHalal Status (Yes/No/Unknown): "+details[1]+"\nExpiration Date: "+details[2]+"\nVolume or Tablets: "+details[3]+"\nPrice: RM"+details[4]+"\nRemaining Stock: "+details[5])
                        ...
                        if next.casefold().strip()=="y":
                            ...
                            do2=input("What would you like to do?\n[E] Edit\n[D] Delete\n[X] Exit\n")
                            if do2.casefold().strip()=="e":
                                changeopt=input("What would you like to change?\n[M] Medicine Name\n[H] Halal Status\n[E] Expiration Date\n[Q] Quantity\n[P] Price\n[R] Remaining Stock\n[C] Category\n[X] Exit\n")
                                if changeopt.casefold().strip()=="m":  #Change medicine name
                                    ...
                                    AMed()
                                elif changeopt.casefold().strip()=="h":  #Change medicine name
                                    ...
                                    AMed()
                                elif changeopt.casefold().strip()=="e":  #Change medicine name
                                    ...
                                    AMed()
                                elif changeopt.casefold().strip()=="q":  #Change medicine name
                                    ...
                                    AMed()
                                elif changeopt.casefold().strip()=="p":  #Change medicine name
                                    ...
                                    AMed()
                                elif changeopt.casefold().strip()=="r":  #Change medicine name
                                    ...
                                    AMed()
                                elif changeopt.casefold().strip()=="c":  #Change medicine name
                                    ...
                                    AMed()
                            elif do2.casefold().strip()=="d":
                                confirm=input("Confirm delete?\n[Y] Yes\n[N] No\n")
                                if confirm.casefold().strip()=="y":
                                    change=False
                                    while change==False:
                                        medicines=open("medicines.txt","r")
                                        buffer=open("buffer.txt","w")
...
Main() #Start the routine from the main menu